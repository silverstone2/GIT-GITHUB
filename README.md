...
### 1. 설치
1. git-scm.com 접속하여 들어가서 git 프로그램 설치<br>
2. 표준으로 설치 후 명령 프롬포트 실행<br>
3. 명령 프롬포트에서 c:\로 디레토리 변경 후 git 입력해서 설치 제대로 됐는지 확인<br>
...
<br>
- status : 현재 git의 상태를 보여주는 명령어로 작업 디렉토리나 스테이지의 정보를 보여준다.<br>
사용 방법 : git status
<br>
...
특징 : commit이 성공적으로 적용이 되면 working tree is clean 이라는 메세지가 출력된다.
